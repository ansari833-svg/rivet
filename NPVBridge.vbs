' ============================================================
'  NPVBridge.vbs  -- single-file NPV Bridge launcher
'
'  Double-click to run. This script injects the modNPVBridge
'  VBA macro into Excel (the active workbook, or a new one) and
'  runs BuildNPVBridge, which prompts you for every component.
'
'  One-time Excel setting required:
...
Dim xl, wb, comp, vbComp, code

' ---- The VBA module source, embedded verbatim ----
code = ""
...
' ---- Attach to a running Excel, or start one ----
...
' ---- Inject the module (remove any prior copy first) ----
On Error Resume Next
For Each comp In wb.VBProject.VBComponents
  If comp.Name = "modNPVBridge" Then wb.VBProject.VBComponents.Remove comp
Next
If Err.Number <> 0 Then
  MsgBox "Cannot access the VBA project." & vbCrLf & vbCrLf & _
    ...
    "then run this again.", vbExclamation, "NPV Bridge"
  WScript.Quit 1
End If
On Error GoTo 0

Set vbComp = wb.VBProject.VBComponents.Add(1)  ' 1 = standard module
vbComp.Name = "modNPVBridge"
